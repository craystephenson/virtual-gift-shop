...
<title>Honchie - Home and Office</title>
</head>
...
<table border="0" width="79%">
  <tr>
    <td width="100%">
      ...
      <area href="food_drink.asp" shape="rect" coords="190, 0, 271, 12">
      <area href="health_beauty.asp" shape="rect" coords="283, 2, 378, 14">
      <area href="apparel.asp" shape="rect" coords="393, 2, 437, 14">
      <area href="services.asp" shape="rect" coords="448, 2, 497, 14">
      <area href="music.asp" shape="rect" coords="511, 2, 586, 14">
      <area href="questions.asp" shape="rect" coords="598, 3, 655, 13">
      <area href="../board/default.asp" shape="rect" coords="674, 5, 707, 13"></map><img border="0" src="../images/storefront/menu.gif" usemap="#FPMap0">&nbsp;</p>
    </td>
  </tr>
</table>
...
s-displaycolumns="name,price,thumbnails" s-criteria="[category] CNT [Home] +" s-order
s-sql="SELECT * FROM products WHERE (category LIKE '%Home%')" b-procedure="FALSE" clientside SuggestedExt="asp"
...
<%
fp_sQry="SELECT * FROM products WHERE (category LIKE '%Home%')"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="15771" endspan -->
<p>&nbsp; </p>
<table border="0" width="56%" height="54">
  <tr>
    ...
    <td width="106%" height="50" valign="middle" align="center">
      <p align="left"><font size="2"><b><a href="../categories_detailed/home_office_detailed.asp?id=<% If Not IsEmpty (fp_rs) Then Response.Write cstr (fp_rs ("id"))%>"><!--webbot bot="DatabaseResultColumn" startspan
...
bot="DatabaseResultColumn" i-CheckSum="5948" endspan --></a></b>  &nbsp;&nbsp;
      <br>
      <br>
