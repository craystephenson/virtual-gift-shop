...
<title>Honchie - Food and Drink</title>
</head>
...
<table border="0" width="102%">
  <tr>
    <td width="100%">
      ...
      <area href="food_drink.asp" shape="rect" coords="188, 2, 269, 14">
      <area href="health_beauty.asp" shape="rect" coords="287, 2, 382, 14">
      <area href="apparel.asp" shape="rect" coords="394, 2, 438, 14">
      <area href="services.asp" shape="rect" coords="449, 2, 498, 14">
      <area href="music.asp" coords="509, 3, 588, 14" shape="rect">
      <area href="questions.asp" shape="rect" coords="603, 2, 654, 14">
      <area href="../board/default.asp" shape="rect" coords="671, 2, 709, 14"></map><img border="0" src="../images/storefront/menu.gif" usemap="#FPMap0" width="710" height="15">&nbsp;&nbsp;&nbsp;</p>
    </td>
  </tr>
</table>
...
s-displaycolumns="name,price,thumbnails" s-criteria="[category] CNT [food] +" s-order
s-sql="SELECT * FROM products WHERE (category LIKE '%food%')" b-procedure="FALSE" clientside SuggestedExt="asp"
...
<%
fp_sQry="SELECT * FROM products WHERE (category LIKE '%food%')"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="15831" endspan -->
<p>&nbsp;&nbsp;</p>
<table border="0" width="56%" height="54">
  <tr>
    ...
    <td width="106%" height="50" valign="middle" align="center">
      <p align="left"><font size="2"><b><a href="../categories_detailed/food_drink_detailed.asp?id=<% If Not IsEmpty (fp_rs) Then Response.Write cstr (fp_rs ("id"))%>"><!--webbot bot="DatabaseResultColumn" startspan
