...
<table border="0" width="102%">
  <tr>
    <td width="100%">
      ...
      <area href="entertainment.asp" shape="rect" coords="102, 2, 177, 14">
      <area href="food_drink.asp" shape="rect" coords="192, 2, 273, 14">
      <area href="health_beauty.asp" shape="rect" coords="283, 2, 372, 14">
      <area href="apparel.asp" shape="rect" coords="391, 2, 435, 14">
      <area href="services.asp" shape="rect" coords="447, 2, 496, 14">
      <area href="../board/default.asp" coords="665, 2, 709, 14" shape="rect">
      <area href="music.asp" shape="rect" coords="507, 2, 589, 13">
      <area href="questions.asp" shape="rect" coords="601, 2, 658, 14"></map><img border="0" src="../images/storefront/menu.gif" usemap="#FPMap0">&nbsp;&nbsp;</p>
    </td>
  </tr>
</table>
...
s-displaycolumns="name,price,thumbnails" s-criteria="[category] CNT [services] +" s-order
s-sql="SELECT * FROM products WHERE (category LIKE '%services%')" b-procedure="FALSE" clientside SuggestedExt="asp"
...
<%
fp_sQry="SELECT * FROM products WHERE (category LIKE '%services%')"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="52234" endspan -->
<p>&nbsp;&nbsp;</p>
<table border="0" width="56%" height="54">
  <tr>
    ...
    <td width="106%" height="50" valign="middle" align="center">
      <p align="left"><font size="2"><b><a href="../categories_detailed/services_detailed.asp?id=<% If Not IsEmpty (fp_rs) Then Response.Write cstr (fp_rs ("id"))%>"><!--webbot bot="DatabaseResultColumn" startspan
