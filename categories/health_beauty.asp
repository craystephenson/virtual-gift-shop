...
<table border="0" width="102%">
  <tr>
    <td width="100%">
      ...
      <area href="home_office.asp" coords="1, 1, 85, 13" shape="rect">
      <area href="entertainment.asp" shape="rect" coords="101, 1, 176, 13">
      <area href="food_drink.asp" shape="rect" coords="189, 1, 270, 13">
      <area href="health_beauty.asp" shape="rect" coords="281, 2, 376, 14">
      <area href="apparel.asp" shape="rect" coords="396, 2, 440, 14">
      <area href="services.asp" shape="rect" coords="449, 2, 498, 14">
      <area href="music.asp" coords="505, 3, 584, 14" shape="rect">
      <area href="questions.asp" shape="rect" coords="599, 2, 650, 14">
      <area href="../board/default.asp" shape="rect" coords="673, 2, 729, 14"></map><img border="0" src="file:///C:/My%20Documents/My%20Webs/Honchie/images/storefront/menu.gif" usemap="#FPMap0">&nbsp;&nbsp;&nbsp;</p>
    </td>
  </tr>
</table>
...
s-displaycolumns="name,price,thumbnails" s-criteria="[category] CNT [health] +" s-order
s-sql="SELECT * FROM products WHERE (category LIKE '%health%')" b-procedure="FALSE" clientside SuggestedExt="asp"
...
<%
fp_sQry="SELECT * FROM products WHERE (category LIKE '%health%')"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="8962" endspan -->
<p>&nbsp;&nbsp;</p>
<table border="0" width="56%" height="54">
  <tr>
    ...
    <td width="106%" height="50" valign="middle" align="center">
      <p align="left"><font size="2"><b><a href="../categories_detailed/health_beauty_detailed.asp?id=<% If Not IsEmpty (fp_rs) Then Response.Write cstr (fp_rs ("id"))%>"><!--webbot bot="DatabaseResultColumn" startspan
