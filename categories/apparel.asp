...
<table border="0" width="95%">
  <tr>
    <td width="100%">
      ...
      <area href="home_office.asp" shape="rect" coords="0, 3, 84, 15">
      <area href="entertainment.asp" shape="rect" coords="101, 0, 176, 14">
      <area href="food_drink.asp" shape="rect" coords="190, 2, 271, 14">
      <area href="health_beauty.asp" shape="rect" coords="282, 2, 377, 14">
      <area href="apparel.asp" shape="rect" coords="395, 0, 434, 14">
      <area href="services.asp" shape="rect" coords="454, 2, 493, 14">
      <area href="music.asp" coords="504, 3, 588, 14" shape="rect">
      <area href="questions.asp" shape="rect" coords="602, 3, 659, 14">
      <area href="../board/default.asp" shape="rect" coords="674, 2, 709, 14"></map><img border="0" src="../images/storefront/menu.gif" usemap="#FPMap0">&nbsp;&nbsp;&nbsp;</p>
    </td>
  </tr>
</table>
...
s-displaycolumns="name,price,thumbnails" s-criteria="[category] CNT [apparel] +" s-order
s-sql="SELECT * FROM products WHERE (category LIKE '%apparel%')" b-procedure="FALSE" clientside SuggestedExt="asp"
...
<%
fp_sQry="SELECT * FROM products WHERE (category LIKE '%apparel%')"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="22753" endspan -->
<p>&nbsp;&nbsp;</p>
