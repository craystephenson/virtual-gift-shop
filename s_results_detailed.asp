...
<title>Honchie - The World's First Virtual Gift Shop</title>
</head>

<body bgcolor="#FFFFFF">

<p><img border="0" src="images/storefront/honchie.gif">
</p>
...
<!--webbot bot="DatabaseRegionStart" i-CheckSum="24164" endspan -->
<table border="0" width="81%" height="40">
  <tr>
    ...
    <td width="31%" height="36" valign="middle" align="center">
      ...
      <a href="orders/orders.asp?id=<%=FP_FieldURL(fp_rs,"id")%>&amp;name=<%=FP_FieldURL(fp_rs,"name")%>">Buy Now!</a><br>
      <br>
